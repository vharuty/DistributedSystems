...
public class ReplicaManager implements RMInterface {
	...
	int m_listeningPort = 2000;
	String m_RMName = "LASALL"; //standard: replica name is the same as clinicID received from client
	...
	public ReplicaManager(){
		...
		m_Replica.put("LASALL1", new Pair("Localhost", 2001));
		m_Replica.put("LASALL2", new Pair("Localhost", 2002));
		m_Replica.put("LASALL3", new Pair("Localhost", 2003));
		
		m_ReplicaManagerList.put("LAVAL", new Pair("Localhost",3000));
		m_ReplicaManagerList.put("MONTREAL", new Pair("Localhost",1000));
	}
