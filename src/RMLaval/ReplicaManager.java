...
public class ReplicaManager implements RMInterface {
	...
	int m_listeningPort = 3000;
	String m_RMName = "LAVAL"; //standard: replica name is the same as clinicID received from client
	...
	public ReplicaManager(){
		...
		m_Replica.put("LAVAL1", new Pair("Localhost", 3001));
		m_Replica.put("LAVAL2", new Pair("Localhost", 3002));
		m_Replica.put("LAVAL3", new Pair("Localhost", 3003));
